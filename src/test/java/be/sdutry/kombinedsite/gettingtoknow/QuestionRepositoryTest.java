...
@DataJpaTest
@SqlGroup({
	@Sql(executionPhase = ExecutionPhase.BEFORE_TEST_METHOD, scripts= "classpath:be/sdutry/kombinedsite/gettingtoknow/init-data.sql"),
...
public class QuestionRepositoryTest {
	...
	void testGetAll() {
		...
		assertThat(questions.get(0).getQuestion()).isEqualTo("getting to know question 1");
		assertThat(questions.get(1).getId()).isEqualTo(2L);
		assertThat(questions.get(1).getQuestion()).isEqualTo("getting to know question 2");
	}
	...
	void testFindById() {
		...
		assertThat(question.getQuestion()).isEqualTo("getting to know question 2");
	}
	
	@Test
	void testSave() {
		Question question = Question.builder().id(3L).question("getting to know question 3").build();
